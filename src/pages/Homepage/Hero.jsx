    ...
    <section className="hero lg:min-h-[85vh] lg:h-[450px] py-4 w-full relative overflow-hidden lg:py-0">
      <div className="max-w-7xl mx-auto px-6 sm:px-6 h-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div className="z-10 text-white text-center order-1">
          ...
          <button onClick={() => navigate("/events/916227b7-e825-4067-ae23-17385707ef32")} className="mt-6 lg:mt-8 px-6 py-3 rounded-xl bg-purple-600 hover:bg-purple-700 transition font-semibold text-sm sm:text-base">
            Start Predicting
          </button>
        </div>
