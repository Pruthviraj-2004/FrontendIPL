      ...
      <div className="max-w-7xl mx-auto px-6">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }}>
          ...
          <motion.p
            ...
            className="mt-6 text-lg text-gray-700 max-w-3xl leading-relaxed"
          >
            Where{" "}
          ...
          <motion.p
            ...
            className="mt-4 text-gray-600 max-w-3xl leading-relaxed"
          >
          ...
          >
            {highlights.map((item, index) => (
              ...
              >
                {/* Icon Placeholder */}
                <div className="w-12 h-12 mb-4 rounded-xl bg-purple-100 flex items-center justify-center text-purple-600 font-bold">
                  ⬤
                </div>
